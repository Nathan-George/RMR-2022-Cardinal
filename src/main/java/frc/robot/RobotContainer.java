...
public class RobotContainer {
  ...
  private final LevitationSystem levitationSystem = new LevitationSystem();
  private final WingardiumLeviosa wingardiumLeviosa = new WingardiumLeviosa(levitationSystem);
